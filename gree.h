// На основании https://github.com/Hagakurje/ESPHome_Gree_AC
// Кое что добавлено
...
//Добавлено для логов
static char const *TAG = "custom";

//ВНИМАНИЕ !!!!
// Должен совпадать с номером пина на строкке 31 в файле ESP12E.yaml
...
public:
  ...
  void setup() override
  {
  //Тут добавлен "preset" в сервис для предустановок
  ...
  climate::ClimateTraits traits()
  {
    ...
    // Поменял отдельно настраивается отображение "target" и "curent" температуры в HA.
    ...
    // Добавлены еще две настройки жалюзи на основании них можно сделать любые две настройки жалюзи.
...
// Добавленые настройки жалюзи  kGreeSwingDown,  kGreeSwingUp можно заменить на свои.
///////////////////////////////////
...
///////////////////////////////////////////////////////
    ...
    ESP_LOGD(TAG, "Gree A/C remote is in the following state:");
    ESP_LOGD(TAG, "  %s\n", ac.toString().c_str());
  }
